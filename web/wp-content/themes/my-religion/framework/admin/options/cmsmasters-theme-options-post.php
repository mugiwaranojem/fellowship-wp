...
if (!function_exists('my_religion_get_custom_post_meta_fields')) {
function my_religion_get_custom_post_meta_fields() {
	$cmsmasters_option = my_religion_get_global_options();
	
	
	$cmsmasters_global_blog_post_layout = (isset($cmsmasters_option['my-religion' . '_blog_post_layout']) && $cmsmasters_option['my-religion' . '_blog_post_layout'] !== '') ? $cmsmasters_option['my-religion' . '_blog_post_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_blog_post_title = (isset($cmsmasters_option['my-religion' . '_blog_post_title']) && $cmsmasters_option['my-religion' . '_blog_post_title'] !== '') ? (($cmsmasters_option['my-religion' . '_blog_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_share_box = (isset($cmsmasters_option['my-religion' . '_blog_post_share_box']) && $cmsmasters_option['my-religion' . '_blog_post_share_box'] !== '') ? (($cmsmasters_option['my-religion' . '_blog_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_author_box = (isset($cmsmasters_option['my-religion' . '_blog_post_author_box']) && $cmsmasters_option['my-religion' . '_blog_post_author_box'] !== '') ? (($cmsmasters_option['my-religion' . '_blog_post_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_more_posts_box = (isset($cmsmasters_option['my-religion' . '_blog_more_posts_box'])) ? $cmsmasters_option['my-religion' . '_blog_more_posts_box'] : 'related';
	...
	$tabs_array['cmsmasters_post'] = array( 
		'label' => esc_html__('Post', 'my-religion'), 
	...
	$custom_post_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Post', 'my-religion'), 
			'desc'	=> esc_html__('Don\'t Show', 'my-religion'), 
		...
		array( 
			'label'	=> esc_html__('Post Image', 'my-religion'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Gallery', 'my-religion'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Audio Links', 'my-religion'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Title', 'my-religion'), 
		...
		array( 
			...
			'desc'	=> esc_html__("Enter the 'Read More' button text that should be used in your blog shortcode", 'my-religion'), 
			'id'	=> $cmsmasters_option_name . 'read_more', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('Continue reading...', 'my-religion') 
		), 
		array( 
			'id'	=> 'cmsmasters_post', 
			'type'	=> 'tab_finish' 
		...
		array( 
			...
			'desc'	=> '</br>' . esc_html__('Choosing layout with a sidebar please make sure to add widgets in the Appearance - Widgets tab. The empty sidebar won\'t be displayed.', 'my-religion'), 
			'id'	=> 'cmsmasters_layout', 
			'type'	=> 'radio_img', 
			'hide'	=> '', 
