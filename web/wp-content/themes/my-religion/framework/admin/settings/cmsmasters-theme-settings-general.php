...
function my_religion_options_general_fields($set_tab = false) {
	...
	case 'general':
		...
		$options[] = array( 
			...
			'desc' => esc_html__('Choose logo image for retina displays. Logo for Retina displays should be twice the size of the default one.', 'my-religion'), 
			'type' => 'upload', 
	...
	case 'header':
		...
		$options[] = array( 
			...
			'choices' => array( 
				...
				esc_html__('Top Line Social Icons (will be shown if Cmsmasters Content Composer plugin is active)', 'my-religion') . '|social', 
				esc_html__('Top Line Navigation (will be shown if set in Appearance - Menus tab)', 'my-religion') . '|nav' 
			) 
		);
	...
	if (CMSMASTERS_DONATIONS) {
		...
		$options[] = array( 
			...
			'choices' => array( 
				esc_html__('None', 'my-religion') . '|none', 
				esc_html__('Header Social Icons (will be shown if Cmsmasters Content Composer plugin is active)', 'my-religion') . '|social', 
	...
	if (CMSMASTERS_WOOCOMMERCE) {
		$options[] = array(
			'section' => 'header_section',
			'id' => 'my-religion' . '_woocommerce_cart_dropdown',
			'title' => esc_html__('Disable WooCommerce Cart', 'my-religion'),
			'desc' => '',
			'type' => 'checkbox',
			'std' => 0
		);
	...
	case 'content':
		$options[] = array( 
			...
			'desc' => esc_html__('Choosing layout with a sidebar please make sure to add widgets to the Sidebar in the Appearance - Widgets tab. The empty sidebar won\'t be displayed.', 'my-religion'),
			'type' => 'radio_img', 
			'std' => 'r_sidebar', 
			'choices' => array( 
		...
		$options[] = array( 
			...
			'desc' => esc_html__('Choosing layout with a sidebar please make sure to add widgets to the Archive Sidebar in the Appearance - Widgets tab. The empty sidebar won\'t be displayed.', 'my-religion'), 
			'type' => 'radio_img', 
			'std' => 'r_sidebar', 
			'choices' => array( 
				esc_html__('Right Sidebar', 'my-religion') . '|' . get_template_directory_uri() . '/framework/admin/inc/img/sidebar_r.jpg' . '|r_sidebar', 
	...
	if (CMSMASTERS_EVENTS_CALENDAR) {
		...
		$options[] = array( 
			...
			'desc' => esc_html__('Layout for pages of non-listed types. Choosing layout with a sidebar please make sure to add widgets to the Sidebar in the Appearance - Widgets tab. The empty sidebar won\'t be displayed.', 'my-religion'), 
			'type' => 'radio_img', 
			'std' => 'r_sidebar', 
			'choices' => array( 
				esc_html__('Right Sidebar', 'my-religion') . '|' . get_template_directory_uri() . '/framework/admin/inc/img/sidebar_r.jpg' . '|r_sidebar', 
		...
		$options[] = array( 
			...
			'title' => esc_html__('Heading Color Scheme by Default', 'my-religion'), 
			'desc' => '', 
			'type' => 'select_scheme', 
			'std' => 'first', 
		...
		$options[] = array( 
			...
			'title' => esc_html__('Bottom Color Scheme', 'my-religion'), 
			'desc' => '', 
			'type' => 'select_scheme', 
			'std' => 'footer', 
			'choices' => cmsmasters_color_schemes_list() 
		...
		$options[] = array( 
			...
			'desc' => esc_html__('show', 'my-religion'). '<br><br>' . esc_html__('Please make sure to add widgets in the Appearance - Widgets tab. The empty sidebar won\'t be displayed.', 'my-religion'), 
			'type' => 'checkbox', 
			'std' => 1 
		);
	...
	case 'footer':
		$options[] = array( 
			...
			'title' => esc_html__('Footer Color Scheme', 'my-religion'), 
			'desc' => '', 
			'type' => 'select_scheme', 
			'std' => 'footer', 
			'choices' => cmsmasters_color_schemes_list() 
		...
		$options[] = array( 
			...
			'choices' => array( 
				esc_html__('None', 'my-religion') . '|none', 
				esc_html__('Footer Navigation (will be shown if set in Appearance - Menus tab', 'my-religion') . '|nav', 
				esc_html__('Social Icons (will be shown if Cmsmasters Content Composer plugin is active)', 'my-religion') . '|social', 
		...
		$options[] = array( 
			...
			'title' => esc_html__('Footer Social Icons (will be shown if Cmsmasters Content Composer plugin is active)', 'my-religion'), 
			'desc' => esc_html__('show', 'my-religion'), 
			'type' => 'checkbox', 
			'std' => 1 
		);
