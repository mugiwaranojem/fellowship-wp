...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Posts', 'my-religion');


$filter_text = ($filter_text != '') ? $filter_text : esc_html__('Filter', 'my-religion');


$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_html__('All Categories', 'my-religion');
