...
if ($best == 'true') {
	if ($best_bg_color != '') {
		...
		'#cmsmasters_pricing_item_' . $unique_id . ' .cmsmasters_button { ' . 
			"\n\t" . cmsmasters_color_css('background-color', $best_bg_color) . 
			"\n\t" . cmsmasters_color_css('border-color', $best_bg_color) . 
		"\n" . '} ' . "\n" . 
		'#cmsmasters_pricing_item_' . $unique_id . ' .cmsmasters_button:hover { ' . 
...
echo my_religion_return_content($price_out);